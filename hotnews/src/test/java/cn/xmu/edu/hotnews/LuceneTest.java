package cn.xmu.edu.hotnews;

import cn.xmu.edu.hotnews.dao.QADao;
...
public class LuceneTest {
    ...
    public void createIndexDB() throws Exception {
        ...
        File file = new File("D:/lucene/qa.txt");
        ...
        while ((lineTxt = bufferedReader.readLine()) != null) {
            if (n == 0) lineTxt += "question###";
            n++;
            if (lineTxt.contains("https://www.zhihu.com/question") && (!lineTxt.contains("answer"))) {
                lineTxt += "@#%###";
                lineTxt = "link###" + lineTxt;
                n = 0;
            }
            allTxt += lineTxt;
        }
        ...
        //把数据填充到JavaBean对象中
        for (String qastr : qas) {
            String[] temp;
            temp = qastr.split("question###|link###");
            question = temp[0];
            answer = temp[1];
            link = temp[2];
            ...
            document.add(new Field("link", link, Field.Store.YES, Field.Index.ANALYZED));
